...
\begin{itemize}
    ...
    \item The slope of coexistence curves on $PT$ phase diagrams.
    \begin{itemize}
        ...
        \begin{align*}
            ...
            (\overline{V}_\alpha-\overline{V}_\beta)\dd{P} &= (\overline{S}_\alpha-\overline{S}_\beta)\dd{T}\\
            \dv{P}{T} &= \frac{\overline{S}_\alpha-\overline{S}_\beta}{\overline{V}_\alpha-\overline{V}_\beta} = \frac{\Delta\overline{S}_\text{trans}}{\Delta\overline{V}_\text{trans}}
        \end{align*}
